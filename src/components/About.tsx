          ...
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
              {[
                ...
                <div
                  key={label}
                  style={{ border: "1px solid rgba(212,168,83,0.1)", padding: "1.2rem", position: "relative" }}
                >
                  <div
                    style={{
                      fontFamily: "'Playfair Display', serif",
                ...
                {languages.map((lang, i) => (
                  ...
                  >
                    <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "6px" }}>
                      <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.85rem", color: "#f0ead6" }}>
                        {lang.name}
                      </span>
                      <span
                        style={{
                    ...
                    >
                      <motion.div
                        ...
                        style={{
                          ...
                          left: 0,
                          height: "100%",
                          background: "linear-gradient(90deg, #d4a853, #c17b3c)",
                        }}
                      />
                    </div>
                  </motion.div>
            ...
            <div style={{ border: "1px solid rgba(212,168,83,0.12)", padding: "1.5rem", position: "relative" }}>
              ...
              >
                "Passionate about writing clean, maintainable code and building reliable systems while continuously
