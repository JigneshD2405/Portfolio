      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 1.5rem" }}>
        ...
        >
          ...
          >
            ...
            >
              Open to new opportunities, collaborations, and interesting challenges. Feel free to reach out — I
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              {[
                ...
                <a
                  ...
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLElement).style.borderColor = "rgba(212,168,83,0.1)";
          ...
          >
            {submitted ? (
              <div style={{ border: "1px solid rgba(212,168,83,0.3)", padding: "3rem", textAlign: "center" }}>
                ...
                <p style={{ fontFamily: "'DM Sans', sans-serif", color: "rgba(240,234,214,0.6)", lineHeight: 1.7 }}>
              ...
              >
                {[
                  ...
                  <div key={field}>
                    ...
                    <input
                      ...
                      onFocus={(e) => {
                        (e.target as HTMLElement).style.borderColor = "rgba(212,168,83,0.4)";
                      }}
                      onBlur={(e) => {
                        (e.target as HTMLElement).style.borderColor = "rgba(212,168,83,0.15)";
                      }}
                    />
                  </div>
                ))}
                ...
                <button
                  ...
                  style={{
                    ...
                    gap: "8px",
                    padding: "12px 24px",
                    background: "linear-gradient(135deg, #d4a853, #c17b3c)",
                    color: "#0d0c0a",
                    border: "none",
                    cursor: "pointer",
                    fontFamily: "'DM Sans', sans-serif",
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.boxShadow = "0 6px 25px rgba(212,168,83,0.25)";
